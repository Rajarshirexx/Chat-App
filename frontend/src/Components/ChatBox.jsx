...
export default function ChatBox() {
    return (
        <div className="chat-box flex flex-col h-75vh relative bg-white/50">
            ...
            <div className="chat-input flex items-center gap-3 px-2.5 py-2.5 bg-white border-t absolute bottom-0 left-0 right-0">
